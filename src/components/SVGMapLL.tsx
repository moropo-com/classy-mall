...
const SvgComponent = ({
  ...
  <Svg width={400} height={560} viewBox="0 0 104 273">
    {/* These are the shops with no name */}
    ...
    {/* These are the shops with a name */}
    <G
    ...
    >
      <Path
        fill={
          getHighlightSvgPropsForShop(SHOP_LIST.bikeshop.key, highlightedShops)
            .fill
        }
        stroke={
          getHighlightSvgPropsForShop(SHOP_LIST.bikeshop.key, highlightedShops)
    ...
    >
      <Path
        fill={
          getHighlightSvgPropsForShop(SHOP_LIST.tea.key, highlightedShops).fill
        }
        stroke={
    ...
    >
      <Path
        fill={
          getHighlightSvgPropsForShop(SHOP_LIST.foodcourt.key, highlightedShops)
            .fill
        }
        stroke={
          getHighlightSvgPropsForShop(SHOP_LIST.foodcourt.key, highlightedShops)
