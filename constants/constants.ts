...
export const SHOPS_UL = Object.values(SHOP_LIST).filter(shop => shop.atLevels.includes(LEVELS.UL));
export const SHOPS_LL = Object.values(SHOP_LIST).filter(shop => shop.atLevels.includes(LEVELS.LL));
